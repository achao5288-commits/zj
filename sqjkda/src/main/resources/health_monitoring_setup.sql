...
-- 5. 插入测试数据
-- 测试设备数据
INSERT INTO `health_devices` (`user_id`, `device_name`, `device_type`, `device_brand`, `device_model`, `device_sn`, `connection_type`, `is_active`, `status`) VALUES
(32, '小米手环7', '智能手环', '小米', 'MI-BAND-7', 'SN2024001', 'Bluetooth', 1, 'online'),
(32, '欧姆龙血压计', '血压计', '欧姆龙', 'HEM-7136', 'SN2024002', 'Bluetooth', 1, 'online'),
(32, '罗氏血糖仪', '血糖仪', '罗氏', 'Accu-Chek', 'SN2024003', 'Bluetooth', 1, 'offline'),
(32, '华为体脂秤', '体脂秤', '华为', 'AH100', 'SN2024004', 'WiFi', 1, 'online');

-- 测试健康监测数据
INSERT INTO `health_monitoring_data` (`user_id`, `device_id`, `data_type`, `data_value`, `data_unit`, `systolic`, `diastolic`, `measurement_time`, `is_abnormal`) VALUES
(32, 1, 'heart_rate', 75, 'bpm', NULL, NULL, '2024-04-20 08:00:00', 0),
(32, 1, 'heart_rate', 82, 'bpm', NULL, NULL, '2024-04-20 14:00:00', 0),
(32, 2, 'blood_pressure', 120, 'mmHg', 120, 80, '2024-04-20 08:30:00', 0),
(32, 2, 'blood_pressure', 145, 'mmHg', 145, 95, '2024-04-20 18:00:00', 1),
(32, 3, 'blood_glucose', 5.6, 'mmol/L', NULL, NULL, '2024-04-20 07:00:00', 0),
(32, 3, 'blood_glucose', 8.2, 'mmol/L', NULL, NULL, '2024-04-20 12:00:00', 1),
(32, 4, 'weight', 68.5, 'kg', NULL, NULL, '2024-04-20 07:30:00', 0),
(32, 1, 'oxygen', 98, '%', NULL, NULL, '2024-04-20 09:00:00', 0),
(32, 1, 'temperature', 36.5, '°C', NULL, NULL, '2024-04-20 08:00:00', 0);

-- 测试健康打卡数据
INSERT INTO `health_checkin` (`user_id`, `checkin_date`, `overall_feeling`, `sleep_quality`, `sleep_hours`, `mood_status`, `exercise_status`, `exercise_minutes`, `diet_status`, `water_intake`, `temperature`, `weight`, `heart_rate`, `medication_status`) VALUES
(32, '2024-04-19', '良好', '良好', 7.5, '愉快', '中度', 30, '正常', 2000, 36.6, 68.2, 72, 1),
(32, '2024-04-20', '良好', '优秀', 8.0, '愉快', '轻度', 20, '正常', 1800, 36.5, 68.5, 75, 1);

-- 测试健康预警数据
INSERT INTO `health_alerts` (`user_id`, `monitor_id`, `alert_type`, `alert_level`, `alert_title`, `alert_content`, `data_type`, `data_value`, `normal_range`, `is_read`, `notify_user`, `notify_doctor`) VALUES
(32, 4, 'device_abnormal', 'warning', '血压异常预警', '您的血压值145/95mmHg偏高，正常范围为90-140/60-90mmHg，请注意休息并监测', 'blood_pressure', '145/95mmHg', '90-140/60-90mmHg', 0, 1, 1),
(32, 6, 'device_abnormal', 'warning', '血糖异常预警', '您的餐后血糖值8.2mmol/L偏高，正常空腹范围为3.9-6.1mmol/L，请注意饮食控制', 'blood_glucose', '8.2mmol/L', '3.9-6.1mmol/L', 1, 1, 0);
